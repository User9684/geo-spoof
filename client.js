...
(() => {
    ...
    window.navigator.geolocation.getCurrentPosition = function (success, fail) {
    ...
    window.navigator.geolocation.watchPosition = function (success, fail) {
    ...
    window.navigator.geolocation.clearWatch = function (watcherId) {
